...
def load_interaction(path, setting, run=0, n_epochs=300, int='train', rsa='testtrainmixed'):
    ...
    """
    # select first run
    path_to_run = path + '/' + str(setting) + '/' + str(run) + '/'
    if int == 'train':
        path_to_interaction = (path_to_run + 'interactions/epoch_' + str(n_epochs) + '/interaction_gpu0')
    elif int == 'val':
        path_to_interaction = (path_to_run + 'interactions/rsa/epoch_' + str(n_epochs) + '/interaction_gpu0')
    elif int == 'test':
